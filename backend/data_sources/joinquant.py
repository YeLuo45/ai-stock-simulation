...
class JoinQuantAdapter:
    ...
    def get_realtime_quote(self, stock_code: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"[JoinQuant] get_realtime_quote failed: {e}")
            return None
    ...
    def get_historical_kline(self, stock_code: str, period: str = "daily",
        ...
        """获取历史K线"""
        try:
            period_map = {"daily": "daily", "weekly": "monthly"}
            ...
            print(f"[JoinQuant] get_historical_kline failed: {e}")
            return None
    ...
    def get_stock_info(self, stock_code: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"[JoinQuant] get_stock_info failed: {e}")
        return None
    ...
    def get_financial_data(self, stock_code: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"[JoinQuant] get_financial_data failed: {e}")
        return None