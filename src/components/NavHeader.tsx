...
import { TrendingUp, BarChart2, Bot, Settings, Wallet, ChevronDown, Star, GitCompare, Clock } from 'lucide-react'
...
const NAV_ITEMS: { key: Page; label: string; icon: React.ReactNode }[] = [
  ...
  { key: 'strategy', label: '多策略', icon: <GitCompare size={18} /> },
  { key: 'trading', label: '交易', icon: <Wallet size={18} /> },
  { key: 'ipo', label: '新股评估', icon: <Star size={18} /> },
  { key: 'history', label: '历史', icon: <Clock size={18} /> },
